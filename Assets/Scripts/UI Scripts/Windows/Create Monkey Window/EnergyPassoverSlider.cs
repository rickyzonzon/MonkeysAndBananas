...
public class EnergyPassoverSlider : MonoBehaviour, ISliders, IPointerDownHandler
{
    ...
    void Start()
    {
        ...
        slider.minValue = GameObject.Find("GameController").GetComponent<GameController>().babyEnergyBounds[0];
        slider.maxValue = GameObject.Find("GameController").GetComponent<GameController>().babyEnergyBounds[1] - 1;
