...
public class IntelligenceSlider : MonoBehaviour, ISliders, IPointerDownHandler
{
    ...
    void Start()
    {
        ...
        slider.minValue = GameObject.Find("GameController").GetComponent<GameController>().intelligenceBounds[0];
        slider.maxValue = GameObject.Find("GameController").GetComponent<GameController>().intelligenceBounds[1];
